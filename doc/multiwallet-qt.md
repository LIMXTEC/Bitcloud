...
In order to support loading of multiple wallets in bitcloud-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcloud.cpp.
...
Changes to bitcloud.cpp
----------------------
bitcloud.cpp is the entry point into bitcloud-qt, and as such, will require some minor modifications to provide hooks for
