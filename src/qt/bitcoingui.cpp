                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BTDX Diamond Core - Wallet 3.0.0.4") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BTDX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitcloud: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BTDX Core"), this);
    aboutAction->setStatusTip(tr("Show information about BTDX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BTDX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BTDX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BTDX addresses"));
    ...
    openAction->setStatusTip(tr("Open a BTDX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BTDX Core help message to get a list with possible BTDX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BTDX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BTDX network", "", count));
}
...
{
    QString strTitle = tr("BTDX Core"); // default title
