...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total bitcloud balance of the wallet\n"
            "  \"Darksend_balance\": xxxxxx, (numeric) the anonymized bitcloud balance of the wallet\n"
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in bitcloud/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in bitcloud/kb\n"
...
#ifdef ENABLE_WALLET
        // Case 1: BTDX address and we have full public key:
