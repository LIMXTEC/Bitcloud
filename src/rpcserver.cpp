...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"bitcloud", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"bitcloud", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcloud", "mnsync", &mnsync, true, true, false},
        {"bitcloud", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"bitcloud", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitcloudd, or the -server option to bitcloud-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
