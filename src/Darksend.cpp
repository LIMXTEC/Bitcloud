    ...
    if (fMasterNode) {
        ...
        BOOST_FOREACH (const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat BTDX and make it unusable. To
...
void CDarksendPool::GetDenominationsToString(int nDenom, std::string& strDenom)
{
    ...
    //
    // bit 0 - 100BTDX+1 ( bit on if present )
    // bit 1 - 10BTDX+1
    // bit 2 - 1BTDX+1
    // bit 3 - .1BTDX+1
    // bit 3 - non-denom
...
void ThreadCheckDarKsendPool()
{
    ...
    RenameThread("bitcloud-Darksend");
