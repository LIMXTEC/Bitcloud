...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
		...
		if (nSporkID == SPORK_15_NEW_PROTOCOL_ENFORCEMENT_3) r = SPORK_15_NEW_PROTOCOL_ENFORCEMENT_3_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
	...
	if (strName == "SPORK_15_NEW_PROTOCOL_ENFORCEMENT_3") return SPORK_15_NEW_PROTOCOL_ENFORCEMENT_3;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
	...
	if (id == SPORK_15_NEW_PROTOCOL_ENFORCEMENT_3) return "SPORK_15_NEW_PROTOCOL_ENFORCEMENT_3";
